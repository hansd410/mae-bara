...
const PRODUCT_HREFS: Record<string, { ko: string; en: string }> = {
  ...
  "Storyroll Shorts":  { ko: "https://storyroll-7mkantrw.manus.space", en: "https://storyroll-7mkantrw.manus.space" },
  "Script2Podcast":    { ko: "https://script2podcast-azx9sws2.manus.space", en: "https://script2podcast-azx9sws2.manus.space" },
  "AI Thumbnail Maker":{ ko: "https://aithumbmaker-3mrpsxkf.manus.space", en: "https://aithumbmaker-3mrpsxkf.manus.space" },
  "Auto Ad Copy":      { ko: "https://autoadcopy-euqzdpp3.manus.space", en: "https://autoadcopy-euqzdpp3.manus.space" },
  "Review2Insight":    { ko: "https://reviewinsight-ppxkqbbc.manus.space", en: "https://reviewinsight-ppxkqbbc.manus.space" },
...
const products = {
  ko: [
    ...
    { icon: Scissors, name: "Storyroll Shorts", subtitle: "AI Short-Form Clip Extractor", desc: "긴 유튜브 영상을 분석해 틱톡/릴스용 숏폼을 자동 추출하고 자막까지 생성합니다. 종량제 크레딧으로 Storyroll 사용자의 숏폼 제작 수요를 흡수합니다.", category: "영상·숏폼", tag: "New" },
    ...
    { icon: Image, name: "AI Thumbnail Maker", subtitle: "AI CTR Thumbnail Generator", desc: "영상 내용을 분석해 클릭률(CTR)이 가장 높을 썸네일 A/B 테스트용 3종을 자동 생성합니다. 유튜브 크리에이터 락인 효과를 제공합니다.", category: "영상·마케팅", tag: "New" },
  ...
  en: [
    ...
    { icon: Scissors, name: "Storyroll Shorts", subtitle: "AI Short-Form Clip Extractor", desc: "Analyzes long YouTube videos and auto-extracts short-form clips for TikTok/Reels with automatic subtitle generation. Pay-per-credit model captures Storyroll users' short-form demand.", category: "Video & Short-Form", tag: "New" },
    ...
    { icon: Image, name: "AI Thumbnail Maker", subtitle: "AI CTR Thumbnail Generator", desc: "Analyzes video content and auto-generates 3 A/B test thumbnails optimized for maximum click-through rate (CTR). Creates a lock-in effect for YouTube creators.", category: "Video Marketing", tag: "New" },
  ...
  zh: [
    ...
    { icon: Scissors, name: "Storyroll Shorts", subtitle: "AI Short-Form Clip Extractor", desc: "分析长YouTube视频，自动提取适合TikTok/Reels的短视频片段并生成字幕。按量付费模式承接Storyroll用户的短片制作需求。", category: "视频·短片", tag: "New" },
    ...
    { icon: Image, name: "AI Thumbnail Maker", subtitle: "AI CTR Thumbnail Generator", desc: "分析视频内容，自动生成3款优化点击率(CTR)的A/B测试缩略图，提升YouTube创作者粘性。", category: "视频营销", tag: "New" },
  ...
  jp: [
    ...
    { icon: Scissors, name: "Storyroll Shorts", subtitle: "AI Short-Form Clip Extractor", desc: "長いYouTube動画を分析し、TikTok/Reels用ショート動画を自動抽出・字幕生成します。従量制クレジットでStoryrollユーザーの短尺コンテンツ需要を取り込みます。", category: "動画・ショート", tag: "New" },
    ...
    { icon: Image, name: "AI Thumbnail Maker", subtitle: "AI CTR Thumbnail Generator", desc: "動画内容を分析し、クリック率(CTR)が最も高いサムネイルA/Bテスト用3種を自動生成します。YouTubeクリエイターのロックイン効果を生み出します。", category: "動画マーケティング", tag: "New" },
